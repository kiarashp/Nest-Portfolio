...
export class InitialSchema1782337932494 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "tag" ("id" SERIAL NOT NULL, "name" character varying(256) NOT NULL, "slug" character varying(256) NOT NULL, "description" text, "schema" text, "featuredImage" character varying(1024), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "UQ_6a9775008add570dc3e5a0bab7b" UNIQUE ("name"), CONSTRAINT "UQ_3413aed3ecde54f832c4f44f045" UNIQUE ("slug"), CONSTRAINT "PK_8e4052373c579afc1471f526760" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TYPE "public"."upload_file_type_enum" AS ENUM('image')`,
    )
    await queryRunner.query(
      `CREATE TABLE "upload_file" ("id" SERIAL NOT NULL, "name" character varying(1024) NOT NULL, "path" character varying(2048) NOT NULL, "publicId" character varying(256) NOT NULL, "type" "public"."upload_file_type_enum" NOT NULL DEFAULT 'image', "mime" character varying(128) NOT NULL, "size" integer NOT NULL, "userId" integer NOT NULL, "postId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_17afec80fc97979415eae19aee0" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "post" ("id" SERIAL NOT NULL, "title" character varying(512) NOT NULL, "postType" "public"."post_posttype_enum" NOT NULL DEFAULT 'post', "slug" character varying(256) NOT NULL, "status" "public"."post_status_enum" NOT NULL DEFAULT 'draft', "content" text, "schema" text, "featuredImage" character varying(1024), "publishOn" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "authorId" integer, CONSTRAINT "UQ_cd1bddce36edc3e766798eab376" UNIQUE ("slug"), CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_enum" AS ENUM('user', 'editor', 'author', 'admin')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "upload_file" ADD CONSTRAINT "FK_4cd0cae97752673f0c17addca27" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
      `ALTER TABLE "upload_file" ADD CONSTRAINT "FK_54ead74a8a53870dd6a0da01e3d" FOREIGN KEY ("postId") REFERENCES "post"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "upload_file" DROP CONSTRAINT "FK_54ead74a8a53870dd6a0da01e3d"`,
    )
    await queryRunner.query(
      `ALTER TABLE "upload_file" DROP CONSTRAINT "FK_4cd0cae97752673f0c17addca27"`,
    )
    await queryRunner.query(
